...
import (
	...
	notifications "github.com/2jairo/courses_app/backend/A_core_service/application/services/notifications"
	...
	"github.com/2jairo/courses_app/backend/A_core_service/application/services/search"
...
type AppServices struct {
	...
	CourseTags        coursetags.CourseTagsService
...
func NewAppServices(repo *infrastructure.AppRepositories, u *utils.AppUtils) *AppServices {
	return &AppServices{
		...
		Notifications:     notifications.NotificationsService{Repo: repo},
		...
		CourseTags:        coursetags.CourseTagsService{Repo: repo},
		...
		Search:            search.SearchService{Repo: repo},
