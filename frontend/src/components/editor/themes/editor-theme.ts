...
export const editorTheme: EditorThemeClasses = {
  ...
  rtl: "text-right",
  heading: {
    h1: "scroll-m-20 text-2xl font-extrabold tracking-tight",
    h2: "scroll-m-20 text-xl font-semibold tracking-tight first:mt-0",
    h3: "scroll-m-20 text-lg font-semibold tracking-tight",
    h4: "scroll-m-20 text-xl font-semibold tracking-tight", // UNUSED
    h5: "scroll-m-20 text-lg font-semibold tracking-tight", // UNUSED
    h6: "scroll-m-20 text-base font-semibold tracking-tight", // UNUSED
  },
  paragraph: "leading-6 [&:not(:first-child)]:mt-0",
