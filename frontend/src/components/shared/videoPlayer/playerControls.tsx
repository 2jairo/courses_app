...
export const PlayerControls = ({
  ...
  const controlsOnFullScreen = fullscreen && !disabledControlsAffectOnFullscreen 
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <section className="flex items-center gap-1.5">
            {(controlsOnFullScreen || !disabledControls.includes("rewind10s")) && (
            ...
            {(controlsOnFullScreen || !disabledControls.includes("pause")) && (
              <Tooltip delayDuration={500}>
                <TooltipTrigger asChild className={controlBtnClass}>
            ...
            {(controlsOnFullScreen || !disabledControls.includes("forward10s")) && (
              <Tooltip delayDuration={500}>
                <TooltipTrigger asChild className={controlBtnClass}>
                  <div className={controlBtnClass} onClick={() => seek((t) => t + 10)}>
            ...
            {(controlsOnFullScreen || !disabledControls.includes("volume")) && (
          ...
          <section className="flex items-center gap-1.5">
            {(controlsOnFullScreen || !disabledControls.includes("settings")) && (
              <div className={controlBtnClass} onClick={() => setShowSettings(true)}>
                <Settings className="size-5" />
              </div>
            )}

            {(controlsOnFullScreen || !disabledControls.includes("fullscreen")) && (
              <Tooltip delayDuration={500}>
                <TooltipTrigger asChild className={controlBtnClass}>
