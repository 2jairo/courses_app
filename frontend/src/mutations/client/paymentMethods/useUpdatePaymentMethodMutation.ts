...
import type { UpdatePaymentMethodRequest, PaymentMethodResponse } from "@/types/client/paymentMethods"
...
export const useUpdatePaymentMethodMutation = () => {
  ...
  return useMutation<PaymentMethodResponse, AxiosError<LocalErrorResponse>, UpdatePaymentMethodRequest>({
    mutationFn: (data: UpdatePaymentMethodRequest) => ClientPaymentMethodsService.updatePaymentMethod(data),
